...
class ADULT2P extends StatefulWidget {
  const ADULT2P({super.key});

  @override
  State<ADULT2P> createState() => _ADULT2PState();
}

class _ADULT2PState extends State<ADULT2P> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Purepet Chicken & Veg Adult Dog Food, 7.5 kg',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- A balanced adult dog food maintains an ideal weight of your pet keeping them active and agile',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- A daily nutrition contains all the essential Vitamins, Minerals and Antioxidants that boosts your pets health and vitality',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- It is easily digestible and supports a healthy immune system',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Purepet is an economical diet that can be served as a whole meal, fulfilling all the nutrional needs of your pet',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
