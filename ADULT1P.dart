...
class ADULT1P extends StatefulWidget {
  const ADULT1P({super.key});

  @override
  State<ADULT1P> createState() => _ADULT1PState();
}

class _ADULT1PState extends State<ADULT1P> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Drools 100% Vegetarian Adult Dry Dog Food',style: TextStyle(
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Complete and balanced nutrition for your adult dog',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
