...
class ADULT7P extends StatefulWidget {
  const ADULT7P({super.key});

  @override
  State<ADULT7P> createState() => _ADULT7PState();
}

class _ADULT7PState extends State<ADULT7P> {
  @override
      ...
      body: SingleChildScrollView(
          child: Column(
            children: [
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('Supercoat Purina Adult Dry Dog Food, 10Kg Pack',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹2,950',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
                      fontWeight: FontWeight.bold,
                      fontSize: 15
                  ),),
                  Text('  ₹2,508',style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                      fontFamily:  'Inter',
                      fontSize: 15
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Tailored nutrition for your dog’s overall health to bring out his active best',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Builds his strong muscle with protein-rich diet',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Develops his shiny coat & healthy skin with Omega 3 & 6 fatty acids',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('-Enhances his immune protection with essential vitamins, minerals and antioxidants',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
