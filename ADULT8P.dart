...
class ADULT8P extends StatefulWidget {
  const ADULT8P({super.key});

  @override
  State<ADULT8P> createState() => _ADULT8PState();
}

class _ADULT8PState extends State<ADULT8P> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('Lets Bite Active Adult Dog Food 10kg',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    ...
                    child: Text('₹1,920',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Omega 3 and 6 for healthy skin and lusturous coat',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- DHA for better retinal and brain function making your pet a smarter and stronger adult',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Made with organic real chicken, egg and chicken liver',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left:20),
                child: Text('- 100% nutrition for over all well-being of your pet and 0% fillers to avoid allergies',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                ...
                child: Text('- Contains 100% organic mineral',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
