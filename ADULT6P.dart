...
class ADULT6P extends StatefulWidget {
  const ADULT6P({super.key});

  @override
  State<ADULT6P> createState() => _ADULT6PState();
}

class _ADULT6PState extends State<ADULT6P> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('SMARTHEART Adult Dry Dog Food Power Pack Adult 3 KG',style: TextStyle(
              ...
              Row(
                children: [
                  Padding(
                    padding: const EdgeInsets.only(left: 20),
                    child: Text('₹1,100',style: TextStyle(
                        color: Colors.black,
                        fontFamily: 'Inter',
              ...
              Padding(
                ...
                child: Text('- Strong Immune System',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
