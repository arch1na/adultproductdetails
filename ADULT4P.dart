...
class ADULT4P extends StatefulWidget {
  const ADULT4P({super.key});

  @override
  State<ADULT4P> createState() => _ADULT4PState();
}

class _ADULT4PState extends State<ADULT4P> {
  @override
          ...
          child: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('Chappi Adult Dry Dog Food, 2.8kg Pack',style: TextStyle(
              ...
              Row(
                children: [
                  ...
                  Text('  ₹505',style: TextStyle(decoration: TextDecoration.lineThrough,
                      color: Color(0xff636161),
                      fontFamily: 'Inter',
                      fontWeight: FontWeight.bold,
                      fontSize: 15
                  ),),
                  Text('  ₹453',style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                      fontFamily:  'Inter',
                      fontSize: 15
              ...
              Padding(
                padding: const EdgeInsets.only(right: 30),
                child: Text('- Complete and balanced food for adult dogs',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Provides dogs quality proteins for healthy muscles',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
              ...
              Padding(
                padding: const EdgeInsets.only(left: 20),
                child: Text('- Comes with dietary fibre to support digestive health',style: TextStyle(
                    color: Colors.black,
                    fontFamily: 'AbhayaLibre',
                    fontSize: 16
                ),),
